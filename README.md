...
1. [What is spring boot ?](#Spring-boot)
1. [What are the core features of Spring ?](#Core-features-of-Spring)
1. [what is annotation ?](#what-is-annotation)
1. [Why spring ?](#why-Spring)
1. [What is inversion of control ?](#Inversion-Of-Control)
1. [What is Dependency Injection ?](#dependency-Injection)
1. [Types of dependency Injection?](#types-of-dependency-Injection)
1. [What is Auto wiring ?](#Auto-Wiring)
1. [What is Application context ?](#Application-context)
1. [What is @Repository annotation ?](#Repository-annotation)
1. [What is @Service annotation ?](#Service-annotation)
1. [What is Application properites ?](#Application-properties)
1. [What is JDBC Template ?](#JDBC-Template)
1. [Describe the flow of HTTPS requests through the Spring Boot application.](#flow-HTTP-Request)
1. [Types of configurations in Spring Boot ?](#Types-of-configurations-in-Spring-Boot)
1. [Spring batch](#Spring-batch)
1. [AOP in Spring](#AOP-in-Spring)
